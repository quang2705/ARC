...
## REST API
Our team provide a simple but useful api for working with the database, reference and documentation of the API can be found here [API documentation](https://github.com/quang2705/ARC/master/API_documentation.md/)
## Authors
